<script type="text/javascript">
	...
	$(document).on("click", ".hapus-dataLaporan", function() {
		...
		$.ajax({
			method: "POST",
			url: "<?php echo base_url('Laporan/delete'); ?>",
			data: "id=" +id
		})
		.done(function(data) {
			$('#konfirmasiHapus').modal('hide');
	...
	$(document).on("click", ".update-dataLaporan", function() {
		...
		$.ajax({
			method: "POST",
			url: "<?php echo base_url('Laporan/update'); ?>",
			data: "id=" +id
		})
		.done(function(data) {
			$('#tempat-modal').html(data);
	...
	$('#form-tambah-laporan').submit(function(e) {
		...
		$.ajax({
			method: 'POST',
			url: '<?php echo base_url('Laporan/prosesTambah'); ?>',
			data: data
		})
		.done(function(data) {
			var out = jQuery.parseJSON(data);
	...
	$(document).on('submit', '#form-update-laporan', function(e){
		...
		$.ajax({
			method: 'POST',
			url: '<?php echo base_url('Laporan/prosesUpdate'); ?>',
			data: data
		})
		.done(function(data) {
			var out = jQuery.parseJSON(data);
